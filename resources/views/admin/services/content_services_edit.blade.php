<div class="wrapper container-fluid">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('name', $data['name'], ['class'=>'form-control', 'placeholder'=>'Enter name of service']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('icon', $data['icon'], ['class'=>'form-control', 'placeholder'=>'Enter icon of service']) !!}
        </div>
    </div>
